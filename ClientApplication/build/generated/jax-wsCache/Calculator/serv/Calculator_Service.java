 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://serv/", wsdlLocation = "http://localhost:8080/ServerApplication/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://serv/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServerApplication/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://serv/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serv/", "CalculatorPort"), Calculator.class, features);
    }
